...
class ImporterTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.library.SetValidDicts(['effects', 'features', 'options', 'jobs'])

    def test_ImportCSV(self):
        effects = Importer.ImportEffects(Path(__file__).parent / '../library_csvs/effects_lib.csv')
        self.library.AddToDict('effects', effects)
